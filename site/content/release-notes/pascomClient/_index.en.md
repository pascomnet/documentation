...
{{% notice warning %}}
**This client version is compatible with pascom phone system server versions 17, 18 and 19.**  
For client versions compatible with older phone system versions, please visit our [Release Archive](https://www.pascom.net/en/downloads/#release-archive).{{% /notice %}}
