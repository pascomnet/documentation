---
title: NetCologne
description: Übersicht zum pascom managed Provider Template von NetCologne
weight: 33
---
...
Tarif in Kombination mit pascom: **Sip Trunk**  

Informationen über Leistungsmerkmale und Tarife finden Sie hier: [NetCologne](https://www.netcologne.de/geschaeftskunden/telefonie/business-telefon).
...
![Netcologne Account Daten](netcologne-account.png?width=70%)
...
Fügen Sie ein neues Amt ein unter {{< ui-button "Gateways" >}} > {{< ui-button "Ämter" >}} > {{< ui-button "Hinzufügen" >}}. Sie gelangen nun zur Ämter-Datenbank. Über den Filter können Sie direkt nach *NetCologne* suchen. Wählen Sie die Vorlage *NetCologne* und befüllen Sie die Vorlage mit den erhaltenen Account-Daten.
