...
Tarif in Kombination mit pascom: **Sipgate Basic, Trunking und Team**  
...
Fügen Sie ein neues Amt ein unter {{< ui-button "Gateways" >}} > {{< ui-button "Ämter" >}} > {{< ui-button "Hinzufügen" >}}. Sie gelangen nun zur Ämter-Datenbank. Über den Filter können Sie direkt nach *Sipgate* suchen. Wählen Sie eine der Vorlagen von *Sipgate* und befüllen Sie die Vorlage mit den erhaltenen Account-Daten.
