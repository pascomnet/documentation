...
Add a new SIP trunk under {{< ui-button "Gateways" >}} > {{< ui-button "Trunks" >}} > {{< ui-button "Add" >}}, which directs you the the SIP provider database. Using the filter, you can search directly for *HFO Telecom* templates. Select the *HFO NGN* template and add your account data / credentials to the template setup wizard.
