...
Tarif in Kombination mit pascom: **Ipfonie extended connect**  
...
Fügen Sie ein neues Amt ein unter {{< ui-button "Gateways" >}} > {{< ui-button "Ämter" >}} > {{< ui-button "Hinzufügen" >}}. Sie gelangen nun zur Ämter-Datenbank. Über den Filter können Sie direkt nach *Plusnet* suchen. Wählen Sie die Vorlage *Plusnet* und befüllen Sie die Vorlage mit den erhaltenen Account-Daten.
