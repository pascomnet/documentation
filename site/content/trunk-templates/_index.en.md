...
|[Wilhelm.tel]( {{< ref "/trunk-templates/wilhelm.tel" >}})|DE|wtSIPfon|<i class='fas fa-check'></i>|<i class='fas fa-times'></i><br/><sub> Is currently not supported.</sub>|
