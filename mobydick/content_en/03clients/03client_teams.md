...
![Screenshot - chart for agents](../../images/client_teams_statistics.png?width=80% "chart for agents")

From the above the chart, you can see when your agents are engaged or free as well as being able to identify when your team requires additional agents due to insufficient agent availability etc.

#### Calls Waiting Overview

![Screenshot - chart for waiting](../../images/client_teams_statstics_callswaiting.png?width=80% "chart for waiting")
