...
The instance name is also visible to every user and therefore should be selected with care, particularly as it is not possible to alter the instance name at a later date. However, you will be able to delete the instance and then add a new instance and import your old instance data using the backup mechanism.
